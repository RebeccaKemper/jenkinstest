sap.ui.define([
	...
	"jenkins/test/jenkinstest/test/integration/pages/Common",
	"jenkins/test/jenkinstest/test/integration/pages/shareOptions"
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("ST_ID"),
								name: oBindingContext.getProperty("ST_DATE")
							};
						}
					}));
				},
